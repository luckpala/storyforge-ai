...
export const DEFAULT_WRITING_SAMPLES = [
  {
    id: 'builtin_luyingji_ch1',
    name: '《鹿鼎记》第一回第1节',
    content: `第一回　纵横钩党清流祸 峭茜风期月旦评
...
　　顾炎武叹了口气，道："这部明史，咱们大家都是看过的了，其中对鞑子不大恭敬，那也是有的。此书本是出于我大明朱国桢相国之手，说到关外建州卫之事，又如何会对鞑子客气？"吕留良点头道："听说湖州庄家花了几千两银子，从朱相国后人手中将明史原稿买了来，以己名刊行，不想竟然酿此大祸。"`,
  ...
  {
    id: 'builtin_chenjinnan',
    name: '陈近南出场',
    content: `船舱门呼的一声，向两旁飞开，一个三十来岁的书生现身舱口，负手背后，脸露微笑。瓜管带喝道："官老爷们在这里办案，你是谁？"那书生微笑不答，迈步踏进船舱。刀光闪动，两柄单刀分从左右劈落。那书生闪身避过，随即欺向瓜管带，挥掌拍向他头顶。瓜管带忙伸左臂挡格，右手成拳，猛力击出。那书生左脚反踢，踹中了一名亲兵胸口，那亲兵大叫一声，登时鲜血狂喷。另外三名亲兵举刀或削或剁。船舱中地形狭窄，那书生施展擒拿功夫，劈击勾打，喀的一声响，一名亲兵给他掌缘劈断了颈骨。瓜管带右掌拍出，击向那书生后脑。那书生反过左掌，砰的一声，双掌相交，瓜管带背心重重撞上船舱，船舱登时塌了一片。那书生连出两掌，拍在余下两名亲兵的胸口，喀喀声响，二人肋骨齐断。
...
　　那书生笑道："贱名适才承蒙黄先生齿及，在下姓陈，草字近南。"`,
  ...
  },
  {
    id: 'builtin_xiaofeng',
    name: '萧峰',
    content: `萧峰身形魁伟，手长脚长，将慕容复提在半空，其势直如老鹰捉小鸡一般。邓百川、公冶乾、包不同、风波恶四人齐叫："休伤我家公子！"一齐奔上。王语嫣也从人丛中抢出，叫道："表哥，表哥！"慕容复恨不得立时死去，免受这难当羞辱。
...
export const DEFAULT_WRITING_GUIDELINES = [
  {
    id: 'builtin_naming_guideline',
    category: '通用',
    content: '所有名字、名称、地名要有自己特色，禁止使用常见网文名称和名字，禁止姓林和苏。名称名字不要有任何寓意，要罕见。除非是引用的情况，否则禁止使用著名的名字名称。',
    isActive: true
  }
];
...
export const DEFAULT_AUTHORS: Author[] = [
  {
    id: 'jinyong',
    name: '金庸',
    description: `武侠小说泰斗，擅长构建宏大的江湖世界，刻画复杂的人物关系，文笔细腻，情节跌宕起伏。其作品以"飞雪连天射白鹿，笑书神侠倚碧鸳"为代表，深受读者喜爱。

**注水艺术（闲笔技巧）**：这是你晚年风格的精华所在，必须在写作时频繁使用这个高超的技巧。

1. **闲笔技巧（必须频繁使用）**：
   - 对话中的闲笔：两个人说话时，要从正事扯到戏文，再扯到赌钱，最后才回到正事。这种看似无关的闲谈，实际上是在丰富人物性格和营造真实感。
   - 情节铺设上的闲笔：在主要情节推进过程中，穿插看似无关但有助于丰富主情节的内容，比如描写食物、典故、历史背景、环境细节等。
   - 但这些闲笔不是啰嗦，不是废话，行文仍然是简练的。
   - 注水的目的是为了让主情节更丰满好看，多数时候是为了刻画角色或者与剧情有关。

2. **叙事节奏**：
   - 开篇慢热，先写环境与配角闲谈，构建历史厚重感与社会背景。
   - 叙事从容，不论多紧张的情节，都要穿插关于食物、典故或看似无关的细节描写。
   - 语言半文半白，夹杂方言俚语，多用成语。

3. **核心原则**：
   - 注水艺术不是简单的填充，而是通过"闲笔"让故事更有层次、更真实、更丰满。
   - 每一个闲笔都应该有其作用：要么刻画人物，要么推进情节，要么营造氛围，要么埋设伏笔。
   - 篇幅可以相当长，但每一处都要有存在的意义。`,
    famousWorks: [
      '《射雕英雄传》',
      '《神雕侠侣》',
      '《倚天屠龙记》',
  ...
  },
  {
    id: 'chenfengxiao',
    name: '陈风笑',
    description: '现代网络文学作家，擅长都市异能、官场商战等题材，文风幽默诙谐，情节紧凑，人物塑造生动。',
    famousWorks: [
      '《官仙》',
      '《狂仙》',
      '《大数据修仙》'
...
// 检查是否已初始化默认内容的 key
export const DEFAULTS_INITIALIZED_KEY = 'storyforge_defaults_initialized';
